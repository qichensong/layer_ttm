...
%             Itgd(iw,mm) = -alpha/kez*...
%              (((T(1,1)*T(2,3)-T(1,3)*T(2,1))*u12*v21)/((T(1,1)*T(2,2)-T(1,2)*T(2,1))*(alpha^2-lambda2)*U)...
%              -((T(1,2)*T(2,3)-T(1,3)*T(2,1))*u22*v11)/((T(1,1)*T(2,2)-T(1,2)*T(2,1))*(alpha^2-lambda1)*U))...
%                 *exp(-q.^2*w0^2/4)/(2*pi)^2;
            % Itgd(iw,mm) = sl2; %((T(1,1)*T(2,3)-T(1,3)*T(2,1))/(T(1,1)*T(2,2)-T(1,2)*T(2,1)))*exp(-q.^2*w0^2/4)/(2*pi)^2;
