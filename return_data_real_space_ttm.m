function fr = return_data_real_space_ttm(omega,w0,w1,xx,yy,rho_cp,kzz,kxx,alp,gamma,Ce,kez,kex,g)
Ld = 6/sqrt((w0^2+w1^2)/2);
nx1 = 80;
[qx,wq]=lgwt(nx1,-Ld,Ld);
%wq = wq; % integrate from -infty to +infty
nw = length(omega);
irec(:,:,:) = freq_response_tensor_qgrid_ttm(omega,w0,w1,qx,rho_cp,kzz,kxx,alp,gamma,Ce,kez,kex,g);
