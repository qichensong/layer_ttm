...
Ce = 1.0e4;%electron volumetric heat capacity [J/m3K]
...
Gpp = 7e7;%phonon-phonon conductance
k2x = 135;%second layer - substate / in-plane thermal conductivity
...
data1 = get_data('/Users/60.moon/Desktop/Research/Thermal conductivity/FDTR/100522_Au films with Qichen/Si_0nmTi_100nmAu_50_Measurement_3_3.11um_17.29mW_21.81C_Sweep_2.txt');
figure(1)
hold on
plot(data1(:,1),data1(:,2)/data1(1,2),'o')
plot(omega/2/pi,amp/amp(1),'LineStyle','-','DisplayName','w/o G_{ep}','LineWidth',1.5)
set(gca, 'XScale', 'log')
xlabel('Frequency (Hz)')
ylabel('Amplitude')
figure(2)
